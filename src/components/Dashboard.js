...
const signOutClickHandler = (msalInstance, accountToSignOut) => {
    msalInstance.logout({
        account: accountToSignOut,
        postLogoutRedirectUri: "http://localhost:3000", // or your desired redirect URL after logout
    });
};
